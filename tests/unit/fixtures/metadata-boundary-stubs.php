...
foreach ( array( 'class-posts.php', 'class-custom-post-types.php', 'class-seo.php' ) as $file ) {
	...
	eval( 'namespace Wstm110Boundary; use \WP_Error; use \Webmastery_MCP_Response; use \Webmastery_MCP_Post_Scheduling; use \Webmastery_MCP_Post_Parent; use \Webmastery_MCP_Untrusted; ' . substr( $source, 5 ) );
}
