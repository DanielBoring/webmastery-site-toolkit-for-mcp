...
- Added mandatory metadata authorization regressions, denied-update/create persisted-state checks, and real-provider two-step SEO coverage to the E2E security policy. Pin real-provider denial fixtures separately from synthetic policies and verify complete creates for explicit unrestricted protected keys and subtype overrides.
