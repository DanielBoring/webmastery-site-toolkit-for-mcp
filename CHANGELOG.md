...
- Image URL validation checks mixed IPv4/IPv6 DNS answers and bounded CNAME chains, including redirect targets. DNS failures are explicit; these checks do not pin DNS or eliminate rebinding races.
